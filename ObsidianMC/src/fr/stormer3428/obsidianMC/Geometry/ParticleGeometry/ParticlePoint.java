...
public class ParticlePoint implements ParticleDrawable{
	...
	@Override
	public ParticlePoint rotateAroundAxis(Vector axis, double radians) {
		location.rotateAroundAxis(axis, radians);
		return this;
	}

	@Override
	public ParticlePoint rotateAroundX(double radians) {
		location.rotateAroundX(radians);
		return this;
	}

	@Override
	public ParticlePoint rotateAroundY(double radians) {
		location.rotateAroundY(radians);
		return this;
	}

	@Override
	public ParticlePoint rotateAroundZ(double radians) {
	...
	public ParticlePoint setLocation(Vector location) {
	...
	@Override
	public ParticlePoint setParticle(Particle particle) {
	...
	public ParticlePoint setParticleAmount(int particleAmount) {
	...
	public ParticlePoint setParticleSpreadX(float particleSpreadX) {
	...
	public ParticlePoint setParticleSpreadY(float particleSpreadY) {
	...
	public ParticlePoint setParticleSpreadZ(float particleSpreadZ) {
	...
	public ParticlePoint setParticleSpeed(float particleSpeed) {
		this.particleSpeed = particleSpeed;
		return this;
	}
	
	@Override
	public ParticlePoint setParticleData(Object particleData) {
		this.particleData = particleData;
		return this;
	}
	
	@Override
	public ParticlePoint setForceRendering(boolean forceRender) {
